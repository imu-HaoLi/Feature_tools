...
[pspectrum,logE] = mag_powspec(samples, sr, wintime, hoptime, dither);
...
% cep = melfcc(input_args, 16000, 'maxfreq', 8000, 'numcep', 13, 'nbands', 20, 'fbtype', 'htkmel', 'dcttype', 3, 'wintime', 0.020, 'hoptime', 0.010, 'sumpower',0, 'lifterexp', -22);
